...
namespace IcefilmsSeriesDownloader
{
    public partial class Form1 : Form
    {
        ...
        private string getSourceDetails(Match episode, String sec, MatchCollection sourceMatches, int i)
        {
            ...
            //}
            // Craft our POST data
            String postData = "id=" + sourceMatches[i].Groups[1] + "&s=" + rand.Next(1, 10) + "&iqs=&url=&m=-" + rand.Next(10, 41) + "&cap=&sec=" + sec + "&t=" + episode.Groups["vid"];
            String sourceResponse = httpPost("https://ipv6.icefilms.info/membersonly/components/com_iceplayer/video.phpAjaxResp.php", postData, "https://ipv6.icefilms.info/membersonly/components/com_iceplayer/video.php?h=374&w=631&vid=" + episode.Groups["vid"] + "&img=");
        ...
        private String httpPost(string strPage, string strBuffer, string referer)
        {
            try
            {
                ...
                WebReq.Headers["Origin"] = "https://ipv6.icefilms.info";
        ...
        {
            if (e.KeyChar == '\r') { btnGo_Click(sender, e); }
        }
    }
}
